...
<tr><td valign=top>Address:</td><td><form><input name=adress value='' size=20><input name=port value='' size=6></td></tr>
<tr><Td valign=top>Login: </td><td><input name=login value='' size=10></td></tr>
<tr><Td valign=top>Pass:</td><td> <input name=pass value='' size=10><input type=hidden name=p value=sql></td></tr>
