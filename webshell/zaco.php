...
<td>
<table align=left>
<tr><td>User :<input name='user' type=text value=''></td><td>Passwd :<input name='passwd' type=text value=''></td><td>Host :<input name='host' type=text value=''></td><td>DB :<input name='db' type=text value=''></td></tr>
<tr><textarea name='query' cols=120 rows=20></textarea></tr>
</table>
</td>
<td>
<table>
<tr><td>DB :</td><td><input type=text name='db_dump' value=''></td></tr>
